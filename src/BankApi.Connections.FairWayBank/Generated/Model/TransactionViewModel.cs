...
namespace BankApi.Connections.FairWayBank.Generated.Model
{
    ...
    public class TransactionViewModel : IEquatable<TransactionViewModel>, IValidatableObject
    {
        ...
        public TransactionViewModel(double? Amount = default(double?), string TransactionInformation = default(string),
            TypeEnum? Type = default(TypeEnum?), DateTime? BookedDate = default(DateTime?))
        {
            this.Amount = Amount;
        ...
        public bool Equals(TransactionViewModel input)
        {
            ...
            return
                ...
                (
                    ...
                    BookedDate != null &&
                    BookedDate.Equals(input.BookedDate)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (TransactionInformation != null)
                    hashCode = hashCode * 59 + TransactionInformation.GetHashCode();
                if (Type != null)
                    hashCode = hashCode * 59 + Type.GetHashCode();
                if (BookedDate != null)
                    hashCode = hashCode * 59 + BookedDate.GetHashCode();
                return hashCode;
            }
        }
    }
